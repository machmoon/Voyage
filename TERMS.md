...
for ambience only. They are not live air-traffic information and must not be
used for navigation, flight planning, safety decisions, or emergency purposes.

You may use Voyage for personal focus sessions in accordance with applicable
...
extent permitted by law, Voyage's contributors are not liable for indirect or
consequential losses arising from use of the app.

These terms may be updated as Voyage and its providers change. Material updates
will be published in this repository with a revised effective date.

Questions can be opened in the
[Voyage issue tracker](https://github.com/machmoon/Voyage/issues).
