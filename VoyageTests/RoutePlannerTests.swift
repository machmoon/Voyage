...
final class RoutePlannerTests: XCTestCase {
    ...
    func testFlightNumberOverrideStampsFirstLeg() {
        let itinerary = RoutePlanner.itinerary(from: bos, to: yqr, flightNumberOverride: "NLN 745")
        XCTAssertEqual(itinerary.legs[0].flightNumber, "NLN 745")
        XCTAssertNotEqual(itinerary.legs[1].flightNumber, "NLN 745",
